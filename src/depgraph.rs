...
pub trait DepGraph {
    fn add_node(&mut self, node_name: String) -> Result<i32, String>;
    fn add_edge(&mut self, node_name_a: String, node_name_b: String) -> Result<i8, String>;
...
impl DepGraph for GraphData {
    fn add_node(&mut self, node_name: String) -> Result<i32, String> {
        ...
        self.name_to_index.insert(node_name.clone(), count);
        self.index_to_name.insert(count, node_name);
